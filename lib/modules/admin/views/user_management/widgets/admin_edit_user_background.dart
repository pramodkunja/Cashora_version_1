...
/// Lavender-gradient background with two radial "blooms" used behind the
/// Admin → Edit User screen. Matches departments / add-user / user-list.
class AdminEditUserBackground extends StatelessWidget {
  const AdminEditUserBackground({super.key});
