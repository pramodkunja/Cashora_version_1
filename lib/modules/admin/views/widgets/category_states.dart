...
/// Empty placeholder shown when no categories exist yet.
...
class CategoryErrorState extends StatelessWidget {
  ...
  const CategoryErrorState({super.key, required this.controller});
...
/// "Add Category" floating action button — gradient pill that opens the
/// controller's create-dialog on tap.
class CategoryGradientFab extends StatelessWidget {
  final CategoryController controller;

  const CategoryGradientFab({super.key, required this.controller});
