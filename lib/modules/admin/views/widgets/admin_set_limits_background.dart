...
/// Decorative gradient + radial bloom background for the admin set-limits screen.
class AdminSetLimitsBackground extends StatelessWidget {
  static const Color _bgA = Color(0xFFF0E9FF);
  static const Color _bgB = Color(0xFFF8F7FF);
  static const Color _bgC = Color(0xFFEEF2FF);

  const AdminSetLimitsBackground({super.key});
